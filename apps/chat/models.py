...
class Messages(models.Model):
	...
	@classmethod
	def add_message(cls, sender, receiver, text=None, image=None):
		...
		message = MessageFeatures.objects.create(	message_type='t',
													text=text,
													image=image,
											)
...
class Dialogue(models.Model):
	participants =  models.ManyToManyField(User, related_name='user_dialogues')
	messages = models.ManyToManyField(Messages, related_name='chat_messages', blank=True)
